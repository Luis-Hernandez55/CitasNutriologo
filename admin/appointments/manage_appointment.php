    ...
    <div class="row" id="appointment">
        <div class="col-6" id="frm-field">
            ...
            <input type="hidden" name="patient_id" value="<?php echo isset($patient_id) ? $patient_id : '' ?>">
                ...
                <div class="form-group">
                    <label for="contact" class="control-label">Número de Contacto</label>
        ...
        <div class="col-6">
            ...
            <div class="form-group">
                <label for="ailment" class="control-label">Si tiene alguna enfermeda o un caso en particular menciónalo a continuación</label>
            ...
            <?php endif; ?>
            <div class="form-group">
                <label for="date_sched" class="control-label">Fecha Cita (Fomato hora 24)</label>
            ...
            <div class="form-group">
                ...
                <select name="status" id="status" class="custom custom-select">
                    <option value="0"<?php echo isset($status) && $status == "0" ? "selected": "" ?>></option>
                    <option value="1"<?php echo isset($status) && $status == "1" ? "selected": "" ?>></option>
                    <option value="2"<?php echo isset($status) && $status == "2" ? "selected": "" ?>></option>
                </select>
            </div>
            <?php else: ?>
